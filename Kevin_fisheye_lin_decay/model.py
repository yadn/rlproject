...
class RecurrentAttention(nn.Module):
    ...
    """
    def __init__(self,
                 g, ## patch size = 8 default
                 k, ## num of patches, default =1
                 s, ## scale of successive patches =2 default
                 c, ## num of channels = 1 default
                 h_g, ## 128 default
                 h_l, ## 128 default
                 std,
                 hidden_size,
        ...
        self.sensor = glimpse_network(h_g, h_l, g, k, s, c) # 128,128, 
